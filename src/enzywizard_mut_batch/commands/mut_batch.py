...
def add_mut_batch_parser(subparsers) -> None:
    ...
    parser.add_argument("--energy_minimize",type=lambda x: str(x).lower() in ["true", "1", "yes"],default=True,help="Whether to perform an energy minimization before energy evaluation (True/False, default: True).")
...
def run_mut_batch(args: Namespace) -> None:
    run_mut_batch_service(
        ...
        minimize_energy=args.energy_minimize,
